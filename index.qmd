...
pacman::p_load(knitr,tidyverse,lubridate,here,dplyr,ggplot2,ggmap,maps,rnaturalearth,rnaturalearthdata,sf,plotly,caret,glmnet,viridis,rcartocolor)
...
export_count_per_year <- read_csv(here("data","cites_ivory_export.csv"))
```
...
# Create a bar plot
ggplot(export_count_per_year, aes(x = as.factor(Year), y = export_count, fill = as.factor(Year))) +
