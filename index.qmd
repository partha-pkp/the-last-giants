...
pacman::p_load(knitr,tidyverse,lubridate,here,dplyr,ggplot2,ggmap,maps,rnaturalearth,rnaturalearthdata,sf,plotly,caret,glmnet,viridis)
```
...
# Assuming `export_count_per_year` is your dataset
export_count_per_year <- export_count_per_year %>%
  filter(Year > 2000)

# Create a ggplot bar plot
gg <- ggplot(export_count_per_year, aes(x = as.factor(Year), y = export_count)) +
