...
pacman::p_load(knitr,tidyverse,lubridate,here,dplyr,here,ggplot2,ggmap,maps,rnaturalearth,rnaturalearthdata,sf,plotly,magick,listviewer,shiny,gganimate)
```
...
# Assuming you have the following elephant_data dataframes
# elephant_data_1996, elephant_data_2005, elephant_data_2006, elephant_data_2010, elephant_data_2014
...
plots[[1]] <- generate_elephant_map(elephant_data_1996, 1996)
plots[[2]] <- generate_elephant_map(elephant_data_2005, 2005)
plots[[3]] <- generate_elephant_map(elephant_data_2006, 2006)
plots[[4]] <- generate_elephant_map(elephant_data_2010, 2010)
plots[[5]] <- generate_elephant_map(elephant_data_2014, 2014)

# Add traces to create an animation
animation <- plot_ly() %>%
  add_trace(plots[[1]], frame = "1996") %>%
  add_trace(plots[[2]], frame = "2005") %>%
  add_trace(plots[[3]], frame = "2006") %>%
  add_trace(plots[[4]], frame = "2010") %>%
  add_trace(plots[[5]], frame = "2014") %>%
  layout(
    updatemenus = list(
      list(
        type = "buttons",
    ...
    sliders = list(
      list(
        active = 0,
        steps = list(
          list(args = list("frame", "1996"),
               label = "1996",
               method = "animate"),
          list(args = list("frame", "2005"),
               label = "2005",
               method = "animate"),
          list(args = list("frame", "2006"),
               label = "2006",
               method = "animate"),
          list(args = list("frame", "2010"),
               label = "2010",
               method = "animate"),
          list(args = list("frame", "2014"),
               label = "2014",
               method = "animate")
        ),
        x = 0.1,
